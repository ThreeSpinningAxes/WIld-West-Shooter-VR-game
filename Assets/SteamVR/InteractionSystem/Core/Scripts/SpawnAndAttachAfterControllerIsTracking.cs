	...
	public class SpawnAndAttachAfterControllerIsTracking : MonoBehaviour
	{
		...
		void Update()
		{
			if ( itemPrefab != null )
			{
                ...
                {
                    GameObject objectToAttach = itemPrefab;
                    objectToAttach.SetActive(true);
                    hand.AttachObject(objectToAttach, GrabTypes.Scripted,Hand.defaultAttachmentFlags, objectToAttach.transform.GetChild(6).transform);
